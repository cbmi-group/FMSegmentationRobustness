...
def generate_adv(net,
    ...
    l_adv_pred = [loss(adv_out, targets) for adv_out in l_adv_out]
    logging.info(f'{l_adv_pred}')
...
def get_args():
    ...
    parser.add_argument('--best', type=int, default=1,help='Whether to load the best model')
